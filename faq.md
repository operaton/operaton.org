...
You can join the Operaton community by participating in the [Forum](https://forum.operaton.org/) or the [Chat (Slack)](https://join.slack.com/t/operaton/shared_invite/zt-2v6umjt92-d2DRmsoR1fqDEVlJB5IkNA).
